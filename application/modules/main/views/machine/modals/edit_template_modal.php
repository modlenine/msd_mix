                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <input id="t_otherImageEdit" name="t_otherImageEdit[]" type="file" class="file" multiple data-show-upload="false" data-show-caption="true" data-show-preview="true" accept="image/*">
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <textarea name="templateremark_edit" id="templateremark_edit" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                    </div>
                    ...
                    <div id="stepSequenceDiv_edit" class="row mt-1 form-group"></div>
